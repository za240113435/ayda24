...
decenas_e = ["", "Veintiuno", "Veintidos", "Veintitres", "Venticuatro", "Veinticinco", "Ventiseis", "Veintisiete", "Veintiocho","Veintinueve"]
...
def Convertir_Numeros(Cantidad):
    ...
    if Cantidad >= 1000000000000:
        ...
        partes.append(Convertir_Numeros(Billones) + " Billon"  + ("es" if Billones > 1 else ""))
    ...
    if Cantidad >= 1000000:
        ...
        partes.append(Convertir_Numeros(millones) + " millón" + ("es" if millones > 1 else ""))
        Cantidad %= 1000000
